...
# 标签
news_label = [int(x.split('_!_')[1])-100 for x in codecs.open('./toutiao_cat_data.txt',encoding='utf-8')]
# 文本
news_text = [x.strip().split('_!_')[-1] if x.strip()[-3:] != '_!_' else x.strip().split('_!_')[-2] for x in codecs.open('./toutiao_cat_data.txt',encoding='utf-8')]
